                ...
                if row_attr_str.strip() in GBKEYS_LIST:
                    ...
                    for row_aggregate in row_aggregates:
                        ...
                        if fits_table_flag:
                            ...
                            print("Typecast dict val: ",typecast_dict[cond_attr])
                            print(cond_attr)
                            if row_agg_func == 'count':
                                ...
                                if typecast_dict[row_agg_attr] == 'string':
                                    print('here is row type str', row[row_agg_attr])
                                    ...
                                    print('here is row type int', row[row_agg_attr])
                                    if mf_struct[row_attr_str][row_aggregate] == None:
                                    ...
                                    #TODO
                                    print('here is row type date', row[row_agg_attr])
                                    print('The type of this: ', type(row[row_agg_attr]))
                                    if mf_struct[row_attr_str][row_aggregate] == None:
                ...
                if HAVING == 'NONE':
                    ...
                    for pred in HAVING_ARR:
                        ...
                        if havingType == 'string':
                            ...
                            print("TYPE OF HAVING VAL", type(having_val))
                            having_val = having_val.date()
                            print("TYPE OF HAVING VAL AFTER CHANGE", type(having_val))
